            ...
            <div className="stats">
                <div className="contribution_count">
                    ...
                    <div className="sparkline-wrapper">
                        <svg width="100%" height="100%" viewBox="0 0 150 50" xmlns="http://www.w3.org/2000/svg">
                            <defs>
                            ...
                            <path
                                ...
                                d="M 0 40 
                                C 5 42.5, 10 45, 15 30 
                                C 20 25, 25 45, 30 20 
                                C 35 0, 40 10, 45 30
                                C 50 35, 55 25, 57.5 20
                                C 60 15, 65 15, 70 20
                                C 75 25, 80 40, 85 15
                                C 90 5, 95 15, 95 15
                                C 100 30, 105 10, 112.5 25
                                C 120 45, 125 15, 130 15
                                C 135 20, 140 40, 145 30
                                C 150 20, 150 20, 150 20
                                L 150 50 L 0 50 Z"
                            />
