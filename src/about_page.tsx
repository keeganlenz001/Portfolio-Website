            ...
            <div className="stats">
                <div className="contributions">
                    ...
                    <div className="sparkline-wrapper">
                        <svg width="100%" height="100%" viewBox="0 0 400 60" xmlns="http://www.w3.org/2000/svg">
                            <defs>
                            ...
                            <path
                                ...
                                d="M 0 45 C 10 45, 15 48, 20 48 C 25 48, 30 35, 40 35 C 50 35, 55 48, 65 48 C 75 48, 80 30, 90 30 C 100 30, 105 45, 110 45 C 120 45, 125 5, 135 5 C 145 5, 150 35, 160 35 C 170 35, 175 15, 185 15 C 195 15, 200 45, 210 45 C 220 45, 225 20, 235 20 C 245 20, 250 45, 260 45 L 260 60 L 0 60 Z"
                                ...
                                // C 50 42, 50 50, 60 50 
                                // C 75 50, 75 32, 85 32 
                                // C 100 32, 100 48, 115 48 
                                // C 125 48, 130 38, 140 38 
                                // C 145 38, 145 44, 150 44 
                                // C 160 44, 160 5, 170 5 
                                // C 180 5, 185 46, 195 46 
                                // C 205 46, 210 22, 220 22 
                                // C 230 22, 230 38, 240 38 
                                // C 250 38, 255 15, 265 15 
                                // C 275 15, 275 26, 285 26 
                                // C 295 26, 295 18, 305 18 
                                // C 315 18, 320 48, 330 48 
                                // C 345 48, 350 25, 360 25 
                                // C 370 25, 370 42, 380 42 
                                // C 390 42, 395 5, 400 5 
                                // L 400 60 L 0 60 Z"
                            />
                            ...
                            <path
                                ...
                                C 40 40, 45 5, 50 5
                                C 60 45, 80 30, 90 30 
                                C 100 30, 105 45, 110 45 
                                C 120 45, 125 5, 135 5 
                                C 145 5, 150 35, 160 35 
                                C 170 35, 175 15, 185 15 
                                C 195 15, 200 45, 210 45 
                                C 220 45, 225 20, 235 20 
                                C 245 20, 250 45, 260 45"
